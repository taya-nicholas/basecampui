...
Docs: https://taya-nicholas.github.io/basecampuicommon.html.md"""
...
# %% ../nbs/01_common.ipynb #cb0a0ddc
def Card(*contents, cls="", **kwargs):
    return Div(
        *contents,
        cls=twm.merge("flex flex-col bg-card border border-border rounded-xl p-4", cls),
        **kwargs
    )

# %% ../nbs/01_common.ipynb #d011bd7d
def CardOutline(*contents, cls="", **kwargs):
    return Div(*contents, cls=twm.merge("bg-background border border-border rounded-xl p-4", cls), **kwargs)
