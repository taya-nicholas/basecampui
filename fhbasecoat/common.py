...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01_common_dup1.ipynb.
...
# %% ../nbs/01_common_dup1.ipynb 8
def AccordionItem(title, content, **kwargs):
    return Details(
        Summary(
            H2(
                title,
                Icon("chevron-down", height=18, width=18, cls="text-muted-foreground pointer-events-none size-4 shrink-0 translate-y-0.5 transition-transform duration-200 group-open:rotate-180"),
...
# %% ../nbs/01_common_dup1.ipynb 12
class AlertT(VEnum):
    default = "alert"
    destructive = "alert-destructive"

# %% ../nbs/01_common_dup1.ipynb 13
...
def Breadcrumb(links:list, hrefs=None):
    ...
    for link, href in zip(links[:-1], hrefs):
        ...
        contents.append(Li(ss("chevron-right", cls="size-3.5")))
